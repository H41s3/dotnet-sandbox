...
namespace Vector
{
    ...
    class Tester
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                temp = new int[problem_size]; data.CopyTo(temp, 0);
                ...
                if (vector.BinarySearch(333, new AscendingIntComparer()) != check) { Console.WriteLine(" :: FAIL"); result += "-"; }
                else { Console.WriteLine(" :: SUCCESS"); result += "A"; }
            }
            catch (Exception ex) { Console.WriteLine(" :: FAIL\n" + ex); result += "-"; }
            ...
            try
            {
                ...
                check = check < 0 ? -1 : check;
                if (vector.BinarySearch(temp[0] - 1, new AscendingIntComparer()) != check) { Console.WriteLine(" :: FAIL"); result += "-"; }
                else { Console.WriteLine(" :: SUCCESS"); result += "B"; }
            }
            catch (Exception ex) { Console.WriteLine(" :: FAIL\n" + ex); result += "-"; }
            ...
            try
            {
                ...
                check = check < 0 ? -1 : check;
                if (vector.BinarySearch(temp[problem_size - 1] + 1, new AscendingIntComparer()) != check) { Console.WriteLine(" :: FAIL"); result += "-"; }
                else { Console.WriteLine(" :: SUCCESS"); result += "C"; }
            }
            catch (Exception ex) { Console.WriteLine(" :: FAIL\n" + ex); result += "-"; }
            ...
            try
            {
                ...
                check = check < 0 ? -1 : check;
                if (vector.BinarySearch(333, new DescendingIntComparer()) != check) { Console.WriteLine(" :: FAIL"); result += "-"; }
                else { Console.WriteLine(" :: SUCCESS"); result += "D"; }
            }
            catch (Exception ex) { Console.WriteLine(" :: FAIL\n" + ex); result += "-"; }
            ...
            try
            {
                ...
                check = check < 0 ? -1 : check;
                if (vector.BinarySearch(temp[0] - 1, new DescendingIntComparer()) != check) { Console.WriteLine(" :: FAIL"); result += "-"; }
                else { Console.WriteLine(" :: SUCCESS"); result += "E"; }
            }
            catch (Exception ex) { Console.WriteLine(" :: FAIL\n" + ex); result += "-"; }
            ...
            try
            {
                ...
                check = check < 0 ? -1 : check;
                if (vector.BinarySearch(temp[problem_size - 1] + 1, new DescendingIntComparer()) != check) { Console.WriteLine(" :: FAIL"); result += "-"; }
                else { Console.WriteLine(" :: SUCCESS"); result += "F"; }
            }
            catch (Exception ex) { Console.WriteLine(" :: FAIL\n" + ex); result += "-"; }
